import{dg as m,dh as f}from"./main-CE5H2ugv.js";import{n as h}from"./class-map-DRM3HWtV.js";import{c as l,a as c}from"./index-CjpFaYOP.js";const p=l`
  :host {
    display: block;
...
`;var n=function(e,o,i,s){var d=arguments.length,t=d<3?o:s===null?s=Object.getOwnPropertyDescriptor(o,i):s,a;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")t=Reflect.decorate(e,o,i,s);else for(var u=e.length-1;u>=0;u--)(a=e[u])&&(t=(d<3?a(t):d>3?a(o,i,t):a(o,i))||t);return d>3&&t&&Object.defineProperty(o,i,t),t};let r=class extends m{constructor(){super(...arguments),this.width="",this.height="",this.variant="default",this.rounded=!1}render(){return this.style.cssText=`
      width: ${this.width};
      height: ${this.height};
    `,this.dataset.rounded=this.rounded?"true":"false",f`<slot></slot>`}};r.styles=[p];n([h()],r.prototype,"width",void 0);n([h()],r.prototype,"height",void 0);n([h()],r.prototype,"variant",void 0);n([h({type:Boolean})],r.prototype,"rounded",void 0);r=n([c("wui-shimmer")],r);
//# sourceMappingURL=index-DUD3rKe6.js.map
