import{dH as N,el as et,dk as g,dl as W,dg as x,dh as l,dr as we,dm as U,em as lt,en as dt,eo as k,d1 as G,ep as ut,eq as L,d7 as F,d8 as P,er as Fe,c$ as f,de as pt,dC as _,d0 as Q,d2 as $,ds as ht,dc as mt,dd as ft,dt as T,di as tt,e4 as wt,dO as me,dD as gt,es as yt}from"./main-CRiqiii6.js";import{n as p,o as y,r as u,a as it}from"./class-map-fATac8zE.js";import{c as E,r as oe,a as b,e as nt,v as de,U as Re,i as bt}from"./index-o4Z4thFC.js";import"./index-BnkTJW5H.js";import{H as qe}from"./HelpersUtil-d3fiDMoP.js";import{C as Ee}from"./ConstantsUtil-DDlug2uz.js";import"./index-gfSlCckn.js";import"./index-B27384PM.js";import"./index-CDtPYIS8.js";import"./index-PCe5w_OE.js";import"./index-CvBU6Clp.js";import"./index-C8TXyW8R.js";import"./index-DlAC80DN.js";import{M as ze}from"./index-imOuPV6O.js";import"./index-ZQl2nQzJ.js";import{S as xt}from"./SwapController-DjL1oMbU.js";import"./index-D58U0yLc.js";import"./index-Cw6Szft2.js";const st={isUnsupportedChainView(){return g.state.view==="UnsupportedChain"||g.state.view==="SwitchNetwork"&&g.state.history.includes("UnsupportedChain")},async safeClose(){if(this.isUnsupportedChainView()){N.shake();return}if(await et.isSIWXCloseDisabled()){N.shake();return}(g.state.view==="DataCapture"||g.state.view==="DataCaptureOtpConfirm")&&W.disconnect(),N.close()}},vt=E`
  :host {
    display: block;
...
`;var Z=function(e,t,i,n){var o=arguments.length,s=o<3?t:n===null?n=Object.getOwnPropertyDescriptor(t,i):n,r;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")s=Reflect.decorate(e,t,i,n);else for(var a=e.length-1;a>=0;a--)(r=e[a])&&(s=(o<3?r(s):o>3?r(t,i,s):r(t,i))||s);return o>3&&s&&Object.defineProperty(t,i,s),s};let q=class extends x{constructor(){super(...arguments),this.icon="card",this.variant="primary",this.type="accent",this.size="md",this.iconSize=void 0,this.fullWidth=!1,this.disabled=!1}render(){return l`<button
    ...
    </button>`}};q.styles=[oe,nt,Ct];Z([p()],q.prototype,"icon",void 0);Z([p()],q.prototype,"variant",void 0);Z([p()],q.prototype,"type",void 0);Z([p()],q.prototype,"size",void 0);Z([p()],q.prototype,"iconSize",void 0);Z([p({type:Boolean})],q.prototype,"fullWidth",void 0);Z([p({type:Boolean})],q.prototype,"disabled",void 0);q=Z([b("wui-icon-button")],q);const Nt=E`
  button {
    display: block;
    display: flex;
    align-items: center;
...
`;var J=function(e,t,i,n){var o=arguments.length,s=o<3?t:n===null?n=Object.getOwnPropertyDescriptor(t,i):n,r;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")s=Reflect.decorate(e,t,i,n);else for(var a=e.length-1;a>=0;a--)(r=e[a])&&(s=(o<3?r(s):o>3?r(t,i,s):r(t,i))||s);return o>3&&s&&Object.defineProperty(t,i,s),s};let z=class extends x{constructor(){super(),this.unsubscribe=[],this.amount=d.state.amount,this.namespace=void 0,this.paymentAsset=d.state.paymentAsset,this.activeConnectorIds=T.state.activeConnectorIds,this.caipAddress=void 0,this.exchanges=d.state.exchanges,this.isLoading=d.state.isLoading,this.initializeNamespace(),this.unsubscribe.push(d.subscribeKey("amount",t=>this.amount=t)),this.unsubscribe.push(T.subscribeKey("activeConnectorIds",t=>this.activeConnectorIds=t)),this.unsubscribe.push(d.subscribeKey("exchanges",t=>this.exchanges=t)),this.unsubscribe.push(d.subscribeKey("isLoading",t=>this.isLoading=t)),d.fetchExchanges(),d.setSelectedExchange(void 0)}disconnectedCallback(){this.unsubscribe.forEach(t=>t())}render(){return l`
    ...
    >
      ...
      </wui-flex>`;const t=this.exchanges.filter(i=>Qt(this.paymentAsset)?i.id===je:i.id!==je);return t.length===0?l`<wui-flex justifyContent="center" alignItems="center">
