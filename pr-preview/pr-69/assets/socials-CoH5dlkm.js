import{dg as O,dt as P,d7 as h,dO as W,dk as f,d6 as T,dh as c,d1 as C,dP as F,dr as D,c$ as d,dl as S,d0 as u,dF as A,d2 as v,dQ as N,dH as R,dD as x}from"./main-CRiqiii6.js";import{n as j,r as l,o as $}from"./class-map-fATac8zE.js";import{c as _,a as I}from"./index-o4Z4thFC.js";import{O as U}from"./index-DFrdJ7OT.js";import{e as M}from"./index-CnEkBYsX.js";import"./index-ZQl2nQzJ.js";import{C as q}from"./ConstantsUtil-DDlug2uz.js";import"./index-gfSlCckn.js";import"./index-Br12ZKuD.js";import"./index-DlAC80DN.js";import"./ref-ClVoVK4L.js";import"./index-PCe5w_OE.js";import"./index-BnkTJW5H.js";import"./browser-BAi_VX8i.js";const z=_`
  :host {
...
`;var g=function(t,e,o,r){var n=arguments.length,i=n<3?e:r===null?r=Object.getOwnPropertyDescriptor(e,o):r,s;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")i=Reflect.decorate(t,e,o,r);else for(var a=t.length-1;a>=0;a--)(s=t[a])&&(i=(n<3?s(i):n>3?s(e,o,i):s(e,o))||i);return n>3&&i&&Object.defineProperty(e,o,i),i};let p=class extends O{constructor(){super(),this.unsubscribe=[],this.tabIdx=void 0,this.connectors=P.state.connectors,this.authConnector=this.connectors.find(e=>e.type==="AUTH"),this.remoteFeatures=h.state.remoteFeatures,this.isPwaLoading=!1,this.hasExceededUsageLimit=W.state.plan.hasExceededUsageLimit,this.unsubscribe.push(P.subscribeKey("connectors",e=>{this.connectors=e,this.authConnector=this.connectors.find(o=>o.type==="AUTH")}),h.subscribeKey("remoteFeatures",e=>this.remoteFeatures=e))}connectedCallback(){super.connectedCallback(),this.handlePwaFrameLoad()}disconnectedCallback(){this.unsubscribe.forEach(e=>e())}render(){var i;let e=((i=this.remoteFeatures)==null?void 0:i.socials)||[];const o=!!this.authConnector,r=e==null?void 0:e.length,n=f.state.view==="ConnectSocials";return(!o||!r)&&!n?null:(n&&!r&&(e=T.DEFAULT_SOCIALS),c` <wui-flex flexDirection="column" gap="2">
...
//# sourceMappingURL=socials-CoH5dlkm.js.map
