import{dA as k,dg as W,dh as v}from"./main-CRiqiii6.js";import{n as y}from"./class-map-fATac8zE.js";import{c as I,r as M,a as O}from"./index-o4Z4thFC.js";import"./index-BnkTJW5H.js";import{Q as N}from"./browser-BAi_VX8i.js";const A=.1,_=2.5,$=7;function x(t,a,d){return t===a?!1:(t-a<0?a-t:t-a)<=d+A}function Q(t,a){const d=Array.prototype.slice.call(N.create(t,{errorCorrectionLevel:a}).modules.data,0),l=Math.sqrt(d.length);return d.reduce((h,f,p)=>(p%l===0?h.push([f]):h[h.length-1].push(f))&&h,[])}const q={generate({uri:t,size:a,logoSize:d,padding:l=8,dotColor:h="var(--apkt-colors-black)"}){const p=[],u=Q(t,"Q"),n=(a-2*l)/u.length,E=[{x:0,y:0},{x:1,y:0},{x:0,y:1}];E.forEach(({x:i,y:e})=>{const s=(u.length-$)*n*i+l,r=(u.length-$)*n*e+l,c=.45;for(let o=0;o<E.length;o+=1){const m=n*($-o*2);p.push(k`
            <rect
...
`;var w=function(t,a,d,l){var h=arguments.length,f=h<3?a:l===null?l=Object.getOwnPropertyDescriptor(a,d):l,p;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")f=Reflect.decorate(t,a,d,l);else for(var u=t.length-1;u>=0;u--)(p=t[u])&&(f=(h<3?p(f):h>3?p(a,d,f):p(a,d))||f);return h>3&&f&&Object.defineProperty(a,d,f),f};let g=class extends W{constructor(){super(...arguments),this.uri="",this.size=500,this.theme="dark",this.imageSrc=void 0,this.alt=void 0,this.arenaClear=void 0,this.farcaster=void 0}render(){return this.dataset.theme=this.theme,this.dataset.clear=String(this.arenaClear),v`<wui-flex
      alignItems="center"
