const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/index-mSaQtmh9.js","assets/main-bRavBTzt.js","assets/main-ROtoQviO.css","assets/ccip-gNxyKRuZ.js","assets/features-DLbIluMh.js","assets/basic-aBxeRbtZ.js","assets/index-B5iL-rC8.js","assets/w3m-modal-BwBaHvQo.js"])))=>i.map(i=>d[i]);
var _d;
import { bk as createTransport, aQ as TransactionRejectedRpcError, b0 as UserRejectedRequestError$1, cR as WalletConnectSessionSettlementError, U as ExecutionRevertedError, cS as wait, cT as process$1, bK as formatUnits, cQ as __vitePreload, by as erc20Abi, cU as Ge, cV as Ue, h as http, cC as toHex, cW as N$1 } from "./main-bRavBTzt.js";
...
async function loadViemUtils() {
  if (!cachedViemUtils) {
    const { createPublicClient, http: http2, defineChain } = await __vitePreload(async () => {
      const { createPublicClient: createPublicClient2, http: http3, defineChain: defineChain2 } = await import("./index-mSaQtmh9.js");
  ...
  async initialize(options) {
    ...
    if (((_e = OptionsController.state.features) == null ? void 0 : _e.reownAuthentication) || ((_f = OptionsController.state.remoteFeatures) == null ? void 0 : _f.reownAuthentication)) {
      const { ReownAuthentication } = await __vitePreload(async () => {
        const { ReownAuthentication: ReownAuthentication2 } = await import("./features-DLbIluMh.js");
...
class AppKit extends AppKitBaseClient {
  ...
  async injectModalUi() {
    if (!isInitialized && CoreHelperUtil.isClient()) {
      await __vitePreload(() => import("./basic-aBxeRbtZ.js"), true ? __vite__mapDeps([5,6,1,2]) : void 0);
      await __vitePreload(() => import("./w3m-modal-BwBaHvQo.js"), true ? __vite__mapDeps([7,6,1,2]) : void 0);
...
//# sourceMappingURL=core-0tIrbN-O.js.map
