  ...
  async function loadViemUtils() {
    if (!cachedViemUtils) {
      const { createPublicClient, http: http2, defineChain } = await __vitePreload(async () => {
        const { createPublicClient: createPublicClient2, http: http3, defineChain: defineChain2 } = await import("./index-B5-PuAzV.js");
        return {
    ...
    async initialize(options) {
      ...
      if (((_e = OptionsController.state.features) == null ? void 0 : _e.reownAuthentication) || ((_f = OptionsController.state.remoteFeatures) == null ? void 0 : _f.reownAuthentication)) {
        const { ReownAuthentication } = await __vitePreload(async () => {
          const { ReownAuthentication: ReownAuthentication2 } = await import("./features-BRJ3J0tH.js");
          return {
  ...
  class AppKit extends AppKitBaseClient {
    ...
    async injectModalUi() {
      if (!isInitialized && CoreHelperUtil.isClient()) {
        await __vitePreload(() => import("./basic-BGS5o2xh.js"), true ? __vite__mapDeps([5,6,1,2]) : void 0);
        await __vitePreload(() => import("./w3m-modal-BhuLg4NN.js"), true ? __vite__mapDeps([7,6,1,2]) : void 0);
