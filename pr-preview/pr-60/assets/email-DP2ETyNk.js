import{a as m,c as S}from"./index-Bblm1NLJ.js";import{W as C}from"./index-DIGWkL0i.js";import{d3 as D,dr as g,db as h,d4 as c,dM as _,dq as s,d6 as f,d5 as b,dl as y,dy as d,dm as u,dn as $,dP as W,ds as P}from"./main-b-ErAfEk.js";import{r as E}from"./class-map-BWu0ptSB.js";import"./index-CUj3ioxm.js";import"./index-DWYQzfLc.js";import{e as N,n as T}from"./ref-4yzkTwOC.js";import"./index-Bpgo9lYV.js";import"./index-D2EPWxDO.js";import"./index-CULdMQH7.js";import"./if-defined-DF7Mn9JA.js";import"./index-Cu_gOqcz.js";var F=function(a,e,t,r){var n=arguments.length,i=n<3?e:r===null?r=Object.getOwnPropertyDescriptor(e,t):r,o;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")i=Reflect.decorate(a,e,t,r);else for(var l=a.length-1;l>=0;l--)(o=a[l])&&(i=(n<3?o(i):n>3?o(e,t,i):o(e,t))||i);return n>3&&i&&Object.defineProperty(e,t,i),i};let I=class extends C{constructor(){super(...arguments),this.onOtpSubmit=async e=>{var t,r;try{if(this.authConnector){const n=D.state.activeChain,i=g.getConnections(n),o=(t=h.state.remoteFeatures)==null?void 0:t.multiWallet,l=i.length>0;if(await this.authConnector.provider.connectOtp({otp:e}),c.sendEvent({type:"track",event:"EMAIL_VERIFICATION_CODE_PASS"}),n)await g.connectExternal(this.authConnector,n);else throw new Error("Active chain is not set on ChainController");if((r=h.state.remoteFeatures)!=null&&r.emailCapture)return;if(h.state.siwx){_.close();return}if(l&&o){s.replace("ProfileWallets"),f.showSuccess("New Wallet Added");return}_.close()}}catch(n){throw c.sendEvent({type:"track",event:"EMAIL_VERIFICATION_CODE_FAIL",properties:{message:b.parseError(n)}}),n}},this.onOtpResend=async e=>{this.authConnector&&(await this.authConnector.provider.connectEmail({email:e}),c.sendEvent({type:"track",event:"EMAIL_VERIFICATION_CODE_SENT"}))}}};I=F([m("w3m-email-verify-otp-view")],I);const U=S`
  wui-icon-box {
...
//# sourceMappingURL=email-DP2ETyNk.js.map
