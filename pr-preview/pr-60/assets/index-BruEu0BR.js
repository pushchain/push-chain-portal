import{dg as v,dh as C,di as _,dl as m,dm as h,db as l}from"./main-BCGy56Tr.js";import{n as b,r as O}from"./class-map-BkJXkDx8.js";import{c as k,r as g,a as y}from"./index-kE4HcXAY.js";import{o as L}from"./if-defined-DqwR2XR0.js";import{e as R,n as j}from"./ref-D0t0_TVO.js";const d=_({isLegalCheckboxChecked:!1}),f={state:d,subscribe(e){return C(d,()=>e(d))},subscribeKey(e,t){return v(d,e,t)},setIsLegalCheckboxChecked(e){d.isLegalCheckboxChecked=e}},z=k`
  label {
    display: inline-flex;
    align-items: center;
    cursor: pointer;
...
`;var x=function(e,t,s,n){var i=arguments.length,o=i<3?t:n===null?n=Object.getOwnPropertyDescriptor(t,s):n,r;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")o=Reflect.decorate(e,t,s,n);else for(var c=e.length-1;c>=0;c--)(r=e[c])&&(o=(i<3?r(o):i>3?r(t,s,o):r(t,s))||o);return i>3&&o&&Object.defineProperty(t,s,o),o};const E={lg:"md",md:"sm",sm:"sm"};let a=class extends m{constructor(){super(...arguments),this.inputElementRef=R(),this.checked=void 0,this.disabled=!1,this.size="md"}render(){const t=E[this.size];return h`
    ...
    `}dispatchChangeEvent(){var t;this.dispatchEvent(new CustomEvent("checkboxChange",{detail:(t=this.inputElementRef.value)==null?void 0:t.checked,bubbles:!0,composed:!0}))}};a.styles=[g,z];x([b({type:Boolean})],a.prototype,"checked",void 0);x([b({type:Boolean})],a.prototype,"disabled",void 0);x([b()],a.prototype,"size",void 0);a=x([y("wui-checkbox")],a);const P=k`
  :host {
    display: flex;
    align-items: center;
    justify-content: center;
...
//# sourceMappingURL=index-BruEu0BR.js.map
