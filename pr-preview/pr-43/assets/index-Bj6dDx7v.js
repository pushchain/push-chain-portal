import{dl as c,dm as a}from"./main-B2cmD9hv.js";import{n as o}from"./class-map-DbQpoWjp.js";import{o as h}from"./if-defined-DHzaASJN.js";import{e as m,n as b}from"./ref-BDKFihUH.js";import{c as x,r as f,e as $,a as g}from"./index-iLvG-8s2.js";const w=x`
  :host {
    position: relative;
    width: 100%;
    display: inline-flex;
...
`;var n=function(t,i,s,u){var p=arguments.length,r=p<3?i:u===null?u=Object.getOwnPropertyDescriptor(i,s):u,l;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")r=Reflect.decorate(t,i,s,u);else for(var d=t.length-1;d>=0;d--)(l=t[d])&&(r=(p<3?l(r):p>3?l(i,s,r):l(i,s))||r);return p>3&&r&&Object.defineProperty(i,s,r),r};let e=class extends c{constructor(){super(...arguments),this.inputElementRef=m(),this.disabled=!1,this.loading=!1,this.placeholder="",this.type="text",this.value="",this.size="md"}render(){return a` <div class="wui-input-text-container">
      ...
      </button>`:null}templateError(){return this.errorText?a`<wui-text variant="sm-regular" color="error">${this.errorText}</wui-text>`:null}templateWarning(){return this.warningText?a`<wui-text variant="sm-regular" color="warning">${this.warningText}</wui-text>`:null}dispatchInputChangeEvent(){var i;this.dispatchEvent(new CustomEvent("inputChange",{detail:(i=this.inputElementRef.value)==null?void 0:i.value,bubbles:!0,composed:!0}))}};e.styles=[f,$,w];n([o()],e.prototype,"icon",void 0);n([o({type:Boolean})],e.prototype,"disabled",void 0);n([o({type:Boolean})],e.prototype,"loading",void 0);n([o()],e.prototype,"placeholder",void 0);n([o()],e.prototype,"type",void 0);n([o()],e.prototype,"value",void 0);n([o()],e.prototype,"errorText",void 0);n([o()],e.prototype,"warningText",void 0);n([o()],e.prototype,"onSubmit",void 0);n([o()],e.prototype,"size",void 0);n([o({attribute:!1})],e.prototype,"onKeyDown",void 0);e=n([g("wui-input-text")],e);
//# sourceMappingURL=index-Bj6dDx7v.js.map
