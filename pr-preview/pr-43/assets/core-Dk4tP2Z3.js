  ...
  async function yh() {
    if (!oc) {
      const { createPublicClient: t, http: e, defineChain: s } = await oa(async () => {
        const { createPublicClient: n, http: r, defineChain: i } = await import("./index-GtV8TdTt.js");
        return {
...
`;
    ...
    async initialize(e) {
      ...
      if (this.initializeProjectSettings(e), this.initControllers(e), await this.initChainAdapters(), this.sendInitializeEvent(e), ((_a2 = e.features) == null ? void 0 : _a2.headless) && !At.hasInjectedConnectors() && ne.prefetch({
        ...
        const { ReownAuthentication: s } = await oa(async () => {
          const { ReownAuthentication: r } = await import("./features-ClmGLLow.js");
          return {
  ...
  class jw extends e3 {
    ...
    async injectModalUi() {
      if (!ap && ee.isClient()) {
        if (await oa(() => import("./basic-Du1yEt4n.js"), __vite__mapDeps([5,6,1,2])), await oa(() => import("./w3m-modal-DSacRtsS.js"), __vite__mapDeps([7,6,1,2])), !document.querySelector("w3m-modal")) {
