const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/index-i5iIHyzO.js","assets/main-CHXxL_j4.js","assets/main-BN-Qqfmx.css","assets/ccip-DzQXO83U.js","assets/features-DgYXgWYz.js","assets/basic-DpwFpcKS.js","assets/index-BDwV6dxP.js","assets/w3m-modal-CPzlwdaG.js"])))=>i.map(i=>d[i]);
  ...
  async function yh() {
    if (!oc) {
      const { createPublicClient: t, http: e, defineChain: s } = await oa(async () => {
        const { createPublicClient: n, http: r, defineChain: i } = await import("./index-i5iIHyzO.js");
        return {
...
`;
    ...
    async initialize(e) {
      ...
      if (this.initializeProjectSettings(e), this.initControllers(e), await this.initChainAdapters(), this.sendInitializeEvent(e), ((_a2 = e.features) == null ? void 0 : _a2.headless) && !At.hasInjectedConnectors() && ne.prefetch({
        ...
        const { ReownAuthentication: s } = await oa(async () => {
          const { ReownAuthentication: r } = await import("./features-DgYXgWYz.js");
          return {
  ...
  class jw extends e3 {
    ...
    async injectModalUi() {
      if (!ap && ee.isClient()) {
        if (await oa(() => import("./basic-DpwFpcKS.js"), __vite__mapDeps([5,6,1,2])), await oa(() => import("./w3m-modal-CPzlwdaG.js"), __vite__mapDeps([7,6,1,2])), !document.querySelector("w3m-modal")) {
