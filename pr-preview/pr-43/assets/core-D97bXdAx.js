  ...
  async function ou() {
    if (!ec) {
      const { createPublicClient: t, http: e, defineChain: n } = await ta(async () => {
        const { createPublicClient: s, http: r, defineChain: i } = await import("./index-eO3UHCO6.js");
        return {
...
`;
    ...
    async initialize(e) {
      ...
      if (this.initializeProjectSettings(e), this.initControllers(e), await this.initChainAdapters(), this.sendInitializeEvent(e), ((_a2 = e.features) == null ? void 0 : _a2.headless) && !At.hasInjectedConnectors() && se.prefetch({
        ...
        const { ReownAuthentication: n } = await ta(async () => {
          const { ReownAuthentication: r } = await import("./features-C45BbsEp.js");
          return {
  ...
  class Nw extends rk {
    ...
    async injectModalUi() {
      if (!Gf && ee.isClient()) {
        if (await ta(() => import("./basic-CCbFs5hS.js"), __vite__mapDeps([5,6,1,2])), await ta(() => import("./w3m-modal-DWzHImel.js"), __vite__mapDeps([7,6,1,2])), !document.querySelector("w3m-modal")) {
