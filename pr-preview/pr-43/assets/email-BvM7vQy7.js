import{a as m,c as S}from"./index-BhGTKZTs.js";import{W as C}from"./index-Bd_bx6Nw.js";import{d3 as D,dr as g,db as h,d4 as c,dM as _,dq as s,d6 as f,d5 as b,dl as y,dy as d,dm as u,dn as $,dP as W,ds as P}from"./main-ITioVySi.js";import{r as E}from"./class-map-r-XHQI0u.js";import"./index-Btf8bYCI.js";import"./index-CFWdDVKP.js";import{e as N,n as T}from"./ref-YPdIXyTg.js";import"./index-D3S3RRQr.js";import"./index-DYMa5Sf0.js";import"./index-CfXJ52Fm.js";import"./if-defined-D-Jz6RC9.js";import"./index-DfBQRyI6.js";var F=function(a,e,t,r){var n=arguments.length,i=n<3?e:r===null?r=Object.getOwnPropertyDescriptor(e,t):r,o;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")i=Reflect.decorate(a,e,t,r);else for(var l=a.length-1;l>=0;l--)(o=a[l])&&(i=(n<3?o(i):n>3?o(e,t,i):o(e,t))||i);return n>3&&i&&Object.defineProperty(e,t,i),i};let I=class extends C{constructor(){super(...arguments),this.onOtpSubmit=async e=>{var t,r;try{if(this.authConnector){const n=D.state.activeChain,i=g.getConnections(n),o=(t=h.state.remoteFeatures)==null?void 0:t.multiWallet,l=i.length>0;if(await this.authConnector.provider.connectOtp({otp:e}),c.sendEvent({type:"track",event:"EMAIL_VERIFICATION_CODE_PASS"}),n)await g.connectExternal(this.authConnector,n);else throw new Error("Active chain is not set on ChainController");if((r=h.state.remoteFeatures)!=null&&r.emailCapture)return;if(h.state.siwx){_.close();return}if(l&&o){s.replace("ProfileWallets"),f.showSuccess("New Wallet Added");return}_.close()}}catch(n){throw c.sendEvent({type:"track",event:"EMAIL_VERIFICATION_CODE_FAIL",properties:{message:b.parseError(n)}}),n}},this.onOtpResend=async e=>{this.authConnector&&(await this.authConnector.provider.connectEmail({email:e}),c.sendEvent({type:"track",event:"EMAIL_VERIFICATION_CODE_SENT"}))}}};I=F([m("w3m-email-verify-otp-view")],I);const U=S`
  wui-icon-box {
...
//# sourceMappingURL=email-BvM7vQy7.js.map
