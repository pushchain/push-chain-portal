const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/index-MceCcHf2.js","assets/main-tnKnLpP0.js","assets/main-BN-Qqfmx.css","assets/ccip-DtjkVqS8.js","assets/features-DI8tBxvU.js","assets/basic-C7Jo0zxv.js","assets/index-xHetFxo5.js","assets/w3m-modal-sA0SkCEF.js"])))=>i.map(i=>d[i]);
import { bk as Is, aQ as Ss, b0 as _s, cR as Ts, U as ks, cS as vs, cT as rn, bK as es, cQ as Lt, by as yt, cU as Os, cV as Rs, h as It, cC as _n, cW as Ps, __tla as __tla_0 } from "./main-tnKnLpP0.js";
  ...
  async function Wn() {
    if (!Zt) {
      const { createPublicClient: e, http: t, defineChain: n } = await Lt(async () => {
        const { createPublicClient: s, http: r, defineChain: a } = await import("./index-MceCcHf2.js");
        return {
...
`;
    ...
    async initialize(t) {
      ...
      if (this.initializeProjectSettings(t), this.initControllers(t), await this.initChainAdapters(), this.sendInitializeEvent(t), ((_a2 = t.features) == null ? void 0 : _a2.headless) && !re.hasInjectedConnectors() && I.prefetch({
        ...
        const { ReownAuthentication: n } = await Lt(async () => {
          const { ReownAuthentication: r } = await import("./features-DI8tBxvU.js");
          return {
  ...
  class ys extends Ba {
    ...
    async injectModalUi() {
      if (!Zn && y.isClient()) {
        if (await Lt(() => import("./basic-C7Jo0zxv.js"), __vite__mapDeps([5,6,1,2])), await Lt(() => import("./w3m-modal-sA0SkCEF.js"), __vite__mapDeps([7,6,1,2])), !document.querySelector("w3m-modal")) {
