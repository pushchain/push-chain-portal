  ...
  async function Il() {
    if (!qo) {
      const { createPublicClient: t, http: e, defineChain: s } = await Zi(async () => {
        const { createPublicClient: n, http: r, defineChain: i } = await import("./index-DEg7S4qd.js");
        return {
...
`;
    ...
    async initialize(e) {
      ...
      if (this.initializeProjectSettings(e), this.initControllers(e), await this.initChainAdapters(), this.sendInitializeEvent(e), ((_a2 = e.features) == null ? void 0 : _a2.headless) && !ht.hasInjectedConnectors() && Z.prefetch({
        ...
        const { ReownAuthentication: s } = await Zi(async () => {
          const { ReownAuthentication: r } = await import("./features-BdjDMX41.js");
          return {
  ...
  class Uf extends L_ {
    ...
    async injectModalUi() {
      if (!zu && Y.isClient()) {
        if (await Zi(() => import("./basic-CEd1MsPc.js"), __vite__mapDeps([5,6,1,2])), await Zi(() => import("./w3m-modal-aRWfHLye.js"), __vite__mapDeps([7,6,1,2])), !document.querySelector("w3m-modal")) {
