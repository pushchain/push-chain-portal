const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/index-BThlpmSz.js","assets/main-DRMrsWj2.js","assets/main-ROtoQviO.css","assets/ccip-DtAQPlFE.js","assets/features-LLvDK9iS.js","assets/basic-CDaVsY1r.js","assets/index-B6ObVXOb.js","assets/w3m-modal-BZD5pFKw.js"])))=>i.map(i=>d[i]);
import { bk as createTransport, aQ as TransactionRejectedRpcError, b0 as UserRejectedRequestError$1, cR as WalletConnectSessionSettlementError, U as ExecutionRevertedError, cS as wait, cT as process$1, bK as formatUnits, cQ as __vitePreload, by as erc20Abi, cU as Ge, cV as Ue, h as http, cC as toHex, cW as N$1, __tla as __tla_0 } from "./main-DRMrsWj2.js";
let AdapterController, ApiController, BlockchainApiController, ChainController, ConstantsUtil$1, E, getActiveNetworkTokenAddress, ConnectorController, subscribeKey, subscribe, proxy, SIWXUtil, ContractUtil, ModalController, NetworkUtil$1, ParseUtil, ProviderController, FetchUtil, RouterController, SafeLocalStorageKeys, HelpersUtil, OptionsController, getNativeTokenAddress, W3mFrameRpcConstants, AssetUtil, AssetController, ThemeController, initializeTheming, ConstantsUtil$2, ConnectorUtil, AppKitError, ErrorUtil$1, ConnectionControllerUtil, CaipNetworksUtil, StorageUtil, WalletUtil, core, SafeLocalStorage, f$1, i, b, fallback, getActiveCaipNetwork, A, i$3, css, elementStyles, NumberUtil, withErrorBoundary, SnackController, ConnectionController, EventsController, getPreferredAccountType, resetStyles, shouldThrow, CoreHelperUtil, u$1, vars, w, SwapApiUtil, AlertController, BalanceUtil;
let __tla = Promise.all([
  ...
  var _d;
  fallback = function(transports_, config = {}) {
        ...
        async request({ method, params }) {
          ...
          const fetch2 = async (i2 = 0) => {
            ...
            try {
              ...
              if (i2 === transports.length - 1) throw err;
              includes ?? (includes = transports.slice(i2 + 1).some((transport3) => {
                const { include, exclude } = transport3({
                  chain
                }).config.methods || {};
  ...
  shouldThrow = function(error) {
    if ("code" in error && typeof error.code === "number") {
      if (error.code === TransactionRejectedRpcError.code || error.code === UserRejectedRequestError$1.code || error.code === WalletConnectSessionSettlementError.code || ExecutionRevertedError.nodeMessage.test(error.message) || error.code === 5e3) return true;
    }
    return false;
  };
  ...
  P$1.cmp = function(y2) {
    var isneg, x2 = this, xc = x2.c, yc = (y2 = new x2.constructor(y2)).c, i2 = x2.s, j = y2.s, k2 = x2.e, l2 = y2.e;
  ...
  P$1.div = function(y2) {
    ...
    var bl, bt, n2, cmp, ri, bz = b2.slice(), ai = bl = b2.length, al = a2.length, r2 = a2.slice(0, bl), rl = r2.length, q = y2, qc = q.c = [], qi = 0, p2 = dp + (q.e = x2.e - y2.e) + 1;
    q.s = k2;
    k2 = p2 < 0 ? 0 : p2;
    bz.unshift(0);
    for (; rl++ < bl; ) r2.push(0);
  ...
  P$1.minus = P$1.sub = function(y2) {
    var i2, j, t2, xlty, x2 = this, Big2 = x2.constructor, a2 = x2.s, b2 = (y2 = new Big2(y2)).s;
    if (a2 != b2) {
      y2.s = -b2;
      return x2.plus(y2);
    }
  ...
  P$1.times = P$1.mul = function(y2) {
    var c2, x2 = this, Big2 = x2.constructor, xc = x2.c, yc = (y2 = new Big2(y2)).c, a2 = xc.length, b2 = yc.length, i2 = x2.e, j = y2.e;
    y2.s = x2.s == y2.s ? 1 : -1;
    if (!xc[0] || !yc[0]) {
      y2.c = [
        y2.e = 0
  ...
  subscribe = function(proxyObject, callback, notifyInSync) {
  ...
  subscribeKey = function(proxyObject, key, callback, notifyInSync) {
  ...
  const SECURE_SITE = (typeof process$1 !== "undefined" && typeof define_process_env_default !== "undefined" ? define_process_env_default["NEXT_PUBLIC_SECURE_SITE_ORIGIN"] : void 0) || "https://secure.walletconnect.org";
    ...
    filterSocialsByPlatform(socials) {
      ...
      if (CoreHelperUtil.isTelegram()) {
        ...
        if (CoreHelperUtil.isAndroid()) {
          filteredSocials = filteredSocials.filter((s2) => ![
            "facebook",
            "x"
          ].includes(s2));
        }
...
${originalFrames}`;
  ...
  withErrorBoundary = function(controller2, defaultCategory = "INTERNAL_SDK_ERROR") {
    const newController = {};
  ...
  AssetController = withErrorBoundary(controller$b);
  ...
  ApiController = {
    ...
    async fetchFeaturedWallets() {
      ...
      if (featuredWalletIds == null ? void 0 : featuredWalletIds.length) {
        ...
        const sortedData = [
          ...data
        ].sort((a2, b2) => featuredWalletIds.indexOf(a2.id) - featuredWalletIds.indexOf(b2.id));
    ...
    async fetchWalletsByPage({ page }) {
      ...
      await Promise.allSettled(images.map((id) => ApiController._fetchWalletImage(id)));
      state$e.wallets = CoreHelperUtil.uniqueBy([
        ...state$e.wallets,
  ...
  ConnectorUtil = {
    ...
    sortConnectorsByPriority(connectors) {
      return [
        ...connectors
      ].sort((a2, b2) => ConnectorUtil.getPriority(a2) - ConnectorUtil.getPriority(b2));
    },
    ...
    async fetchProviderData(connector) {
      ...
      try {
        ...
        const [accounts, chainId] = await Promise.all([
          (_a = connector.provider) == null ? void 0 : _a.request({
            method: "eth_accounts"
          }),
          (_b = connector.provider) == null ? void 0 : _b.request({
            method: "eth_chainId"
      ...
      for (const type of connectorTypeOrder) {
        switch (type) {
          ...
          case "recent": {
            ...
            filteredRecent.forEach((w2) => items.push({
              kind: "wallet",
              subtype: "recent",
              wallet: w2
            }));
          ...
          case "injected": {
            multiChain.forEach((c2) => items.push({
              kind: "connector",
              subtype: "multiChain",
              connector: c2
            }));
            announced.forEach((c2) => items.push({
              kind: "connector",
              subtype: "announced",
              connector: c2
            }));
            injected.forEach((c2) => items.push({
              kind: "connector",
              subtype: "injected",
              connector: c2
            }));
          ...
          case "featured": {
            featured.forEach((w2) => items.push({
              kind: "wallet",
              subtype: "featured",
              wallet: w2
            }));
          ...
          case "custom": {
            ...
            filteredCustom.forEach((w2) => items.push({
              kind: "wallet",
              subtype: "custom",
              wallet: w2
            }));
          ...
          case "external": {
            external.forEach((c2) => items.push({
              kind: "connector",
              subtype: "external",
              connector: c2
            }));
          ...
          case "recommended": {
            ...
            cappedRecommended.forEach((w2) => items.push({
              kind: "wallet",
              subtype: "recommended",
              wallet: w2
            }));
  ...
  RouterController = withErrorBoundary(controller$a);
  const state$c = proxy({
    themeMode: "dark",
    themeVariables: {},
  ...
  ThemeController = withErrorBoundary(controller$9);
  const defaultActiveConnectors = Object.fromEntries(AVAILABLE_NAMESPACES.map((namespace) => [
    namespace,
    void 0
  ]));
  const defaultFilterByNamespaceMap = Object.fromEntries(AVAILABLE_NAMESPACES.map((namespace) => [
    namespace,
    true
  ]));
  const state$b = proxy({
        ...
        if (namespace) {
          const unsubscribeChainController = ChainController.subscribeChainProp("accountState", (val) => {
            if (val == null ? void 0 : val.caipAddress) {
              resolve({
                caipAddress: val == null ? void 0 : val.caipAddress
              });
  ...
  ConnectorController = withErrorBoundary(controller$8);
  ...
  getActiveNetworkTokenAddress = function() {
    var _a, _b;
  ...
  getNativeTokenAddress = function(namespace) {
    return ConstantsUtil$1.NATIVE_TOKEN_ADDRESS[namespace];
  };
  getPreferredAccountType = function(namespace) {
    var _a;
  ...
  getActiveCaipNetwork = function(chainNamespace) {
  ...
  ConnectionControllerUtil = {
    ...
    getConnectionsData(namespace) {
      ...
      const dedupedRecentConnections = ConnectionControllerUtil.excludeExistingConnections([
        ...connections.map((c2) => c2.connectorId),
        ...activeConnectorId ? [
          activeConnectorId
        ] : []
      ...
      transactions.forEach((transaction) => {
        ...
        grouped[year] = {
          ...
          [month]: [
            ...
            transaction
          ].sort((a2, b2) => new Date(b2.metadata.minedAt).getTime() - new Date(a2.metadata.minedAt).getTime())
        };
      });
      return grouped;
    },
  ...
  const controller$6 = {
    ...
    async disconnectConnector({ id, namespace }) {
      var _a;
      try {
        await ((_a = ConnectionController._getClient()) == null ? void 0 : _a.disconnectConnector({
          id,
          namespace
        }));
      } catch (error) {
  ...
  ConnectionController = withErrorBoundary(controller$6);
  const ERC7811Utils = {
  ...
  async function loadViemUtils() {
    if (!cachedViemUtils) {
      const { createPublicClient, http: http2, defineChain } = await __vitePreload(async () => {
        const { createPublicClient: createPublicClient2, http: http3, defineChain: defineChain2 } = await import("./index-BThlpmSz.js");
        return {
    ...
    async fetchGasPrice() {
      ...
      try {
        switch (caipNetwork.chainNamespace) {
          case "solana":
            const lamportsPerSignature = (_a = await (ConnectionController == null ? void 0 : ConnectionController.estimateGas({
  ...
  const controller$4 = {
    ...
    initialize(adapters, caipNetworks, clients) {
      ...
      const namespaces = OptionsController.state.enableEmbedded ? /* @__PURE__ */ new Set([
        ...namespacesFromAdapters
      ]) : /* @__PURE__ */ new Set([
        ...(caipNetworks == null ? void 0 : caipNetworks.map((network) => network.chainNamespace)) ?? []
      ]);
      ...
      if (!state$4.noAdapters) {
        ...
        if (state$4.activeChain) {
          PublicStateController.set({
            activeChain: adapterToActivate == null ? void 0 : adapterToActivate.namespace
          });
        }
      }
      namespaces.forEach((namespace) => {
    ...
    addNetwork(network) {
      ...
      if (chainAdapter) {
        ...
        state$4.chains.set(network.chainNamespace, {
          ...chainAdapter,
    ...
    getRequestedCaipNetworkIds() {
      ...
      const chains = namespace ? [
        state$4.chains.get(namespace)
      ] : Array.from(state$4.chains.values());
    ...
    getCaipNetworkById(id, namespace) {
      return controller$4.getCaipNetworks(namespace).find((n2) => n2.id.toString() === id.toString() || n2.caipNetworkId.toString() === id.toString());
    },
  ...
  ChainController = withErrorBoundary(controller$4);
  const NetworkUtil = {
    onSwitchNetwork({ network, ignoreSwitchConfirmation = false }) {
      ...
      } else if (isCurrentNamespaceConnected && isDifferentNamespace && !isNextNamespaceConnected) {
  ...
  ModalController = withErrorBoundary(controller$3);
  ...
  SIWXUtil = {
    ...
    async authConnectorAuthenticate({ authConnector, chainId, socialUri, preferredAccountType, chainNamespace }) {
      ...
      const network = getActiveCaipNetwork();
      if (!siwx || !chainNamespace.includes(ConstantsUtil$2.CHAIN.EVM) || ((_a = OptionsController.state.remoteFeatures) == null ? void 0 : _a.emailCapture)) {
  ...
  AlertController = withErrorBoundary(controller);
  const baseUSDC = {
  ...
  let r$2, S$1, c$2;
  r$2 = (t2) => new n$2("string" == typeof t2 ? t2 : t2 + "", void 0, s$2);
  i$3 = (t2, ...e2) => {
  ...
  let i$2, e$1, h$1, r$1, o$2, n$1, a$1, c$1, l$1, p$1, d$1, b$1;
  ({ is: i$2, defineProperty: e$1, getOwnPropertyDescriptor: h$1, getOwnPropertyNames: r$1, getOwnPropertySymbols: o$2, getPrototypeOf: n$1 } = Object);
  a$1 = globalThis;
  ...
  let y$1 = class y extends HTMLElement {
    ...
    static _$Ei() {
      ...
      const t2 = n$1(this);
      t2.finalize(), void 0 !== t2.l && (this.l = [
        ...t2.l
    ...
    _$AK(t2, s2) {
      ...
      if (void 0 !== e2 && this._$Em !== e2) {
        ...
        } : void 0 !== ((_a = t3.converter) == null ? void 0 : _a.fromAttribute) ? t3.converter : u$1;
        this._$Em = e2;
  ...
  y$1.elementStyles = [], y$1.shadowRootOptions = {
    mode: "open"
  }, y$1[d$1("elementProperties")] = /* @__PURE__ */ new Map(), y$1[d$1("finalized")] = /* @__PURE__ */ new Map(), p$1 == null ? void 0 : p$1({
    ReactiveElement: y$1
  }), (a$1.reactiveElementVersions ?? (a$1.reactiveElementVersions = [])).push("2.1.2");
  let t, i$1, s$1, e, h, o$1, n, r, l, c, a, u, d, f, v, _, m, p, g, $, y, x, C, P;
  t = globalThis;
  i$1 = (t2) => t2;
  s$1 = t.trustedTypes;
  ...
  u = Array.isArray;
  d = (t2) => u(t2) || "function" == typeof (t2 == null ? void 0 : t2[Symbol.iterator]);
  f = "[ 	\n\f\r]";
  v = /<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g;
  _ = /-->/g;
  m = />/g;
...
\f\r"'\`<>=]|("|')|))|$)`, "g");
  ...
  const N = (t2, i2) => {
    ...
    return [
      V(t2, l2 + (t2[s2] || "<?>") + (2 === i2 ? "</svg>" : 3 === i2 ? "</math>" : "")),
      e2
    ];
  };
  class S {
  ...
  i._$litElement$ = true, i["finalized"] = true, (_d = s.litElementHydrateSupport) == null ? void 0 : _d.call(s, {
    LitElement: i
  });
  ...
  ({ cssVariablesVarPrefix: vars } = ThemeHelperUtil.createCSSVariables(styles));
  ...
  initializeTheming = function(themeVariables, themeMode = "dark") {
...
`;
                ...
                params: [
                  {
                    chainId: toHex(caipNetwork.id),
                    rpcUrls: [
                      (_d2 = caipNetwork == null ? void 0 : caipNetwork.rpcUrls["chainDefault"]) == null ? void 0 : _d2.http
                    ],
                    chainName: caipNetwork.name,
                    nativeCurrency: caipNetwork.nativeCurrency,
                    blockExplorerUrls: [
                      (_e = caipNetwork.blockExplorers) == null ? void 0 : _e.default.url
                    ]
                  }
                ]
              }));
  ...
  class AppKitBaseClient {
    ...
    async initialize(options) {
      ...
      if (((_e = OptionsController.state.features) == null ? void 0 : _e.reownAuthentication) || ((_f = OptionsController.state.remoteFeatures) == null ? void 0 : _f.reownAuthentication)) {
        const { ReownAuthentication } = await __vitePreload(async () => {
          const { ReownAuthentication: ReownAuthentication2 } = await import("./features-LLvDK9iS.js");
          return {
            ReownAuthentication: ReownAuthentication2
          };
      ...
      this.connectionControllerClient = {
        ...
        reconnectExternal: async ({ id, info, type, provider }) => {
          ...
          if (adapter == null ? void 0 : adapter.reconnect) {
            await (adapter == null ? void 0 : adapter.reconnect({
              id,
              info,
              type,
              provider,
        ...
        writeContract: async (args) => {
          ...
          const result = await (adapter == null ? void 0 : adapter.writeContract({
            ...args,
            caipNetwork,
            provider,
            caipAddress
        ...
        parseUnits: (value, decimals) => {
          ...
          return (adapter == null ? void 0 : adapter.parseUnits({
            value,
            decimals
          })) ?? 0n;
        },
        formatUnits: (value, decimals) => {
          ...
          return (adapter == null ? void 0 : adapter.formatUnits({
            value,
            decimals
          })) ?? "0";
        },
    ...
    async syncAccount(params) {
      ...
      if (chainIdToUse) {
        ...
        if (!shouldSupportAllNetworks && !caipNetwork && !fallbackCaipNetwork) {
          ...
          fallbackCaipNetwork = this.getCaipNetworks().find((n2) => n2.caipNetworkId === fallBackCaipNetworkId || "deprecatedCaipNetworkId" in n2 && n2.deprecatedCaipNetworkId === fallBackCaipNetworkId);
        }
        ...
        if (isActiveNamespace) {
          ...
          await this.syncBalance({
            address,
            chainId: networkOfChain == null ? void 0 : networkOfChain.id,
            chainNamespace
          });
        }
        this.syncIdentity({
    ...
    async syncBalance(params) {
      const caipNetwork = NetworkUtil$1.getNetworksByNamespace(this.getCaipNetworks(), params.chainNamespace).find((n2) => {
        var _a;
  ...
  class AppKit extends AppKitBaseClient {
    ...
    async injectModalUi() {
      if (!isInitialized && CoreHelperUtil.isClient()) {
        await __vitePreload(() => import("./basic-CDaVsY1r.js"), true ? __vite__mapDeps([5,6,1,2]) : void 0);
        await __vitePreload(() => import("./w3m-modal-BZD5pFKw.js"), true ? __vite__mapDeps([7,6,1,2]) : void 0);
  ...
  core = Object.freeze(Object.defineProperty({
    __proto__: null,
    AppKit,
    createAppKit
  }, Symbol.toStringTag, {
