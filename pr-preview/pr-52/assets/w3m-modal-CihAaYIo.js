import { p as ue, s as pe, q as me, t as he, i as v, r as E, a as f, b as a, u as j, e as te, o as ie, R as l, j as g, f as H, k as ve, v as k, E as F, x as M, M as m, O as A, C as V, y as J, l as $, A as D, T as fe, z as ge, c as be, h as ye } from "./core-BMVRSG4c.js";
import { c as u, n as d, r as w, o as X, U as xe } from "./index-B9HTR4Bx.js";
import "./main-v_QDCm_K.js";
const p = he({ message: "", open: false, triggerRect: { width: 0, height: 0, top: 0, left: 0 }, variant: "shade" }), Ce = { state: p, subscribe(r) {
  return me(p, () => r(p));
}, subscribeKey(r, e) {
  return pe(p, r, e);
}, showTooltip({ message: r, triggerRect: e, variant: t }) {
  p.open = true, p.message = r, p.triggerRect = e, p.variant = t;
}, hide() {
  p.open = false, p.message = "", p.triggerRect = { width: 0, height: 0, top: 0, left: 0 };
} }, T = ue(Ce), ke = v`
  :host {
    display: block;
...
S.styles = [E, Ne];
I([d()], S.prototype, "message", void 0);
I([d()], S.prototype, "backgroundColor", void 0);
I([d()], S.prototype, "iconColor", void 0);
I([d()], S.prototype, "icon", void 0);
S = I([u("wui-alertbar")], S);
const We = v`
  :host {
    display: block;
    position: absolute;
...
`;
var oe = function(r, e, t, o) {
  var n = arguments.length, i = n < 3 ? e : o === null ? o = Object.getOwnPropertyDescriptor(e, t) : o, s;
  if (typeof Reflect == "object" && typeof Reflect.decorate == "function") i = Reflect.decorate(r, e, t, o);
  else for (var c = r.length - 1; c >= 0; c--) (s = r[c]) && (i = (n < 3 ? s(i) : n > 3 ? s(e, t, i) : s(e, t)) || i);
  return n > 3 && i && Object.defineProperty(e, t, i), i;
};
const Re = { info: { backgroundColor: "fg-350", iconColor: "fg-325", icon: "info" }, success: { backgroundColor: "success-glass-reown-020", iconColor: "success-125", icon: "checkmark" }, warning: { backgroundColor: "warning-glass-reown-020", iconColor: "warning-100", icon: "warningCircle" }, error: { backgroundColor: "error-glass-reown-020", iconColor: "error-125", icon: "exclamationTriangle" } };
let U = class extends f {
  constructor() {
    super(), this.unsubscribe = [], this.open = j.state.open, this.onOpen(true), this.unsubscribe.push(j.subscribeKey("open", (e) => {
  ...
  render() {
    const { message: e, variant: t } = j.state, o = Re[t];
    return a`
      <wui-alertbar
        message=${e}
...
U.styles = We;
oe([w()], U.prototype, "open", void 0);
U = oe([u("w3m-alertbar")], U);
const $e = v`
  button {
...
N.styles = [E, te, ie, $e];
P([d()], N.prototype, "size", void 0);
P([d({ type: Boolean })], N.prototype, "disabled", void 0);
P([d()], N.prototype, "icon", void 0);
P([d()], N.prototype, "iconColor", void 0);
N = P([u("wui-icon-link")], N);
const Te = v`
  button {
    display: block;
    display: flex;
...
L.styles = [E, te, ie, Te];
ae([d()], L.prototype, "imageSrc", void 0);
L = ae([u("wui-select")], L);
const Ae = v`
  :host {
    height: 64px;
...
const Oe = ["SmartSessionList"];
function K() {
  var _a, _b, _c, _d, _e2, _f, _g;
  const r = (_b = (_a = l.state.data) == null ? void 0 : _a.connector) == null ? void 0 : _b.name, e = (_d = (_c = l.state.data) == null ? void 0 : _c.wallet) == null ? void 0 : _d.name, t = (_f = (_e2 = l.state.data) == null ? void 0 : _e2.network) == null ? void 0 : _f.name, o = e ?? r, n = V.getConnectors();
  return { Connect: `Connect ${n.length === 1 && ((_g = n[0]) == null ? void 0 : _g.id) === "w3m-email" ? "Email" : ""} Wallet`, Create: "Create Wallet", ChooseAccountName: void 0, Account: void 0, AccountSettings: void 0, AllWallets: "All Wallets", ApproveTransaction: "Approve Transaction", BuyInProgress: "Buy", ConnectingExternal: o ?? "Connect Wallet", ConnectingWalletConnect: o ?? "WalletConnect", ConnectingWalletConnectBasic: "WalletConnect", ConnectingSiwe: "Sign In", Convert: "Convert", ConvertSelectToken: "Select token", ConvertPreview: "Preview convert", Downloads: o ? `Get ${o}` : "Downloads", EmailLogin: "Email Login", EmailVerifyOtp: "Confirm Email", EmailVerifyDevice: "Register Device", GetWallet: "Get a wallet", Networks: "Choose Network", OnRampProviders: "Choose Provider", OnRampActivity: "Activity", OnRampTokenSelect: "Select Token", OnRampFiatSelect: "Select Currency", Pay: "How you pay", Profile: void 0, SwitchNetwork: t ?? "Switch Network", SwitchAddress: "Switch Address", Transactions: "Activity", UnsupportedChain: "Switch Network", UpgradeEmailWallet: "Upgrade your Wallet", UpdateEmailWallet: "Edit Email", UpdateEmailPrimaryOtp: "Confirm Current Email", UpdateEmailSecondaryOtp: "Confirm New Email", WhatIsABuy: "What is Buy?", RegisterAccountName: "Choose name", RegisterAccountNameSuccess: "", WalletReceive: "Receive", WalletCompatibleNetworks: "Compatible Networks", Swap: "Swap", SwapSelectToken: "Select token", SwapPreview: "Preview swap", WalletSend: "Send", WalletSendPreview: "Review send", WalletSendSelectToken: "Select Token", WhatIsANetwork: "What is a network?", WhatIsAWallet: "What is a wallet?", ConnectWallets: "Connect wallet", ConnectSocials: "All socials", ConnectingSocial: J.state.socialProvider ? J.state.socialProvider : "Connect Social", ConnectingMultiChain: "Select chain", ConnectingFarcaster: "Farcaster", SwitchActiveChain: "Switch chain", SmartSessionCreated: void 0, SmartSessionList: "Smart Sessions", SIWXSignMessage: "Sign In", PayLoading: "Payment in progress" };
}
let h = class extends f {
  constructor() {
    super(), this.unsubscribe = [], this.heading = K()[l.state.view], this.network = g.state.activeCaipNetwork, this.networkImage = H.getNetworkImage(this.network), this.showBack = false, this.prevHistoryLength = 1, this.view = l.state.view, this.viewDirection = "", this.headerText = K()[l.state.view], this.unsubscribe.push(ve.subscribeNetworkImages(() => {
    ...
    }), g.subscribeKey("activeCaipNetwork", (e) => {
  ...
  onWalletHelp() {
    F.sendEvent({ type: "track", event: "CLICK_WALLET_HELP" }), l.push("WhatIsAWallet");
  }
  async onClose() {
    l.state.view === "UnsupportedChain" || await M.isSIWXCloseDisabled() ? m.shake() : m.close(true);
  }
  rightHeaderTemplate() {
    var _a, _b, _c;
    const e = (_c = (_b = (_a = A) == null ? void 0 : _a.state) == null ? void 0 : _b.features) == null ? void 0 : _c.smartSessions;
  ...
  leftHeaderTemplate() {
    var _a;
    const { view: e } = l.state, t = e === "Connect", o = A.state.enableEmbedded, n = e === "ApproveTransaction", i = e === "ConnectingSiwe", s = e === "Account", c = A.state.enableNetworkSwitch, G = n || i || t && o;
    return s && c ? a`<wui-select
        id="dynamic"
        data-testid="w3m-account-select-network"
        active-network=${X((_a = this.network) == null ? void 0 : _a.name)}
  ...
  onNetworks() {
    this.isAllowedNetworkSwitch() && (F.sendEvent({ type: "track", event: "CLICK_NETWORKS" }), l.push("Networks"));
  }
  isAllowedNetworkSwitch() {
    const e = g.getAllRequestedCaipNetworks(), t = e ? e.length > 1 : false, o = e == null ? void 0 : e.find(({ id: n }) => {
      var _a;
      return n === ((_a = this.network) == null ? void 0 : _a.id);
    });
    return t || !o;
  }
  getPadding() {
  ...
  async onHistoryChange() {
    var _a;
    const { history: e } = l.state, t = (_a = this.shadowRoot) == null ? void 0 : _a.querySelector("#dynamic");
    e.length > 1 && !this.showBack && t ? (await t.animate([{ opacity: 1 }, { opacity: 0 }], { duration: 200, fill: "forwards", easing: "ease" }).finished, this.showBack = true, t.animate([{ opacity: 0 }, { opacity: 1 }], { duration: 200, fill: "forwards", easing: "ease" })) : e.length <= 1 && this.showBack && t && (await t.animate([{ opacity: 1 }, { opacity: 0 }], { duration: 200, fill: "forwards", easing: "ease" }).finished, this.showBack = false, t.animate([{ opacity: 0 }, { opacity: 1 }], { duration: 200, fill: "forwards", easing: "ease" }));
  }
  onGoBack() {
    l.goBack();
  }
...
h.styles = Ae;
y([w()], h.prototype, "heading", void 0);
y([w()], h.prototype, "network", void 0);
y([w()], h.prototype, "networkImage", void 0);
y([w()], h.prototype, "showBack", void 0);
y([w()], h.prototype, "prevHistoryLength", void 0);
y([w()], h.prototype, "view", void 0);
y([w()], h.prototype, "viewDirection", void 0);
y([w()], h.prototype, "headerText", void 0);
h = y([u("w3m-header")], h);
const Ee = v`
  :host {
    display: flex;
...
b.styles = [E, Ee];
R([d()], b.prototype, "backgroundColor", void 0);
R([d()], b.prototype, "iconColor", void 0);
R([d()], b.prototype, "icon", void 0);
R([d()], b.prototype, "message", void 0);
R([d()], b.prototype, "loading", void 0);
R([d()], b.prototype, "iconType", void 0);
b = R([u("wui-snackbar")], b);
const Ie = v`
  :host {
    display: block;
    position: absolute;
...
const Pe = { loading: void 0, success: { backgroundColor: "success-100", iconColor: "success-100", icon: "checkmark" }, error: { backgroundColor: "error-100", iconColor: "error-100", icon: "close" } };
let z = class extends f {
  ...
  render() {
    const { message: e, variant: t, svg: o } = $.state, n = Pe[t], { icon: i, iconColor: s } = o ?? n ?? {};
    return a`
      <wui-snackbar
        message=${e}
  ...
  onOpen() {
    clearTimeout(this.timeout), this.open ? (this.animate([{ opacity: 0, transform: "translateX(-50%) scale(0.85)" }, { opacity: 1, transform: "translateX(-50%) scale(1)" }], { duration: 150, fill: "forwards", easing: "ease" }), this.timeout && clearTimeout(this.timeout), $.state.autoClose && (this.timeout = setTimeout(() => $.hide(), 2500))) : this.animate([{ opacity: 1, transform: "translateX(-50%) scale(1)" }, { opacity: 0, transform: "translateX(-50%) scale(0.85)" }], { duration: 150, fill: "forwards", easing: "ease" });
  }
};
z.styles = Ie;
ne([w()], z.prototype, "open", void 0);
z = ne([u("w3m-snackbar")], z);
const _e = v`
  :host {
    pointer-events: none;
  }
...
let W = class extends f {
  constructor() {
    super(), this.unsubscribe = [], this.open = T.state.open, this.message = T.state.message, this.triggerRect = T.state.triggerRect, this.variant = T.state.variant, this.unsubscribe.push(T.subscribe((e) => {
...
W.styles = [_e];
_([w()], W.prototype, "open", void 0);
_([w()], W.prototype, "message", void 0);
_([w()], W.prototype, "triggerRect", void 0);
_([w()], W.prototype, "variant", void 0);
W = _([u("w3m-tooltip"), u("w3m-tooltip")], W);
const Be = v`
  :host {
    --prev-height: 0px;
    --new-height: 0px;
...
let O = class extends f {
  ...
  disconnectedCallback() {
    var _a;
    (_a = this.resizeObserver) == null ? void 0 : _a.unobserve(this.getWrapper()), this.unsubscribe.forEach((e) => e());
  }
  render() {
...
O.styles = Be;
q([w()], O.prototype, "view", void 0);
q([w()], O.prototype, "viewDirection", void 0);
O = q([u("w3m-router")], O);
const De = v`
  :host {
...
class x extends f {
  constructor() {
    super(), this.unsubscribe = [], this.abortController = void 0, this.hasPrefetched = false, this.enableEmbedded = A.state.enableEmbedded, this.open = m.state.open, this.caipAddress = g.state.activeCaipAddress, this.caipNetwork = g.state.activeCaipNetwork, this.shake = m.state.shake, this.filterByNamespace = V.state.filterByNamespace, this.initializeTheming(), D.prefetchAnalyticsConfig(), this.unsubscribe.push(m.subscribeKey("open", (e) => e ? this.onOpen() : this.onClose()), m.subscribeKey("shake", (e) => this.shake = e), g.subscribeKey("activeCaipNetwork", (e) => this.onNewNetwork(e)), g.subscribeKey("activeCaipAddress", (e) => this.onNewAddress(e)), A.subscribeKey("enableEmbedded", (e) => this.enableEmbedded = e), V.subscribeKey("filterByNamespace", (e) => {
      var _a;
      this.filterByNamespace !== e && !((_a = g.getAccountData(e)) == null ? void 0 : _a.caipAddress) && (D.fetchRecommendedWallets(), this.filterByNamespace = e);
    }));
  }
  firstUpdated() {
    if (this.caipAddress) {
      if (this.enableEmbedded) {
        m.close(), this.prefetch();
        return;
      }
  ...
  async handleClose() {
    l.state.view === "UnsupportedChain" || await M.isSIWXCloseDisabled() ? m.shake() : m.close();
  }
  initializeTheming() {
    const { themeVariables: e, themeMode: t } = fe.state, o = xe.getColorTheme(t);
    ge(e, o);
  }
  onClose() {
    this.open = false, this.classList.remove("open"), this.onScrollUnlock(), $.hide(), this.onRemoveKeyboardListener();
  }
  onOpen() {
  ...
  onAddKeyboardListener() {
    ...
    const e = (_a = this.shadowRoot) == null ? void 0 : _a.querySelector("wui-card");
    e == null ? void 0 : e.focus(), window.addEventListener("keydown", (t) => {
      if (t.key === "Escape") this.handleClose();
      else if (t.key === "Tab") {
        const { tagName: o } = t.target;
        o && !o.includes("W3M-") && !o.includes("WUI-") && (e == null ? void 0 : e.focus());
      }
  ...
  async onNewAddress(e) {
    const t = g.state.isSwitchingNamespace, o = be.getPlainAddress(e);
    !o && !t ? m.close() : t && o && l.goBack(), await M.initializeIfEnabled(), this.caipAddress = e, g.setIsSwitchingNamespace(false);
  }
  onNewNetwork(e) {
    var _a, _b;
    const t = this.caipNetwork, o = (_a = t == null ? void 0 : t.caipNetworkId) == null ? void 0 : _a.toString(), n = t == null ? void 0 : t.chainNamespace, i = (_b = e == null ? void 0 : e.caipNetworkId) == null ? void 0 : _b.toString(), s = e == null ? void 0 : e.chainNamespace, c = o !== i, re = c && !(n !== s), se = (t == null ? void 0 : t.name) === ye.UNSUPPORTED_NETWORK_NAME, ce = l.state.view === "ConnectingExternal", le = !this.caipAddress, we = l.state.view === "UnsupportedChain", de = m.state.open;
    let B = false;
    de && !ce && (le ? c && (B = true) : (we || re && !se) && (B = true)), B && l.state.view !== "SIWXSignMessage" && l.goBack(), this.caipNetwork = e;
  }
  prefetch() {
    this.hasPrefetched || (D.prefetch(), D.fetchWalletsByPage({ page: 1 }), this.hasPrefetched = true);
  }
}
x.styles = De;
C([d({ type: Boolean })], x.prototype, "enableEmbedded", void 0);
C([w()], x.prototype, "open", void 0);
C([w()], x.prototype, "caipAddress", void 0);
C([w()], x.prototype, "caipNetwork", void 0);
C([w()], x.prototype, "shake", void 0);
C([w()], x.prototype, "filterByNamespace", void 0);
let Z = class extends x {
};
Z = C([u("w3m-modal")], Z);
let ee = class extends x {
};
ee = C([u("appkit-modal")], ee);
export {
  ee as AppKitModal,
  Z as W3mModal,
  x as W3mModalBase
